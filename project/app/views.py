...
from .forms import CustomerOrderForm, UserRegistrationForm
...
from .forms import UserProfileUpdate, UserupdateForm, ProductUpdateForm

from .models import Products, Category, Order, CustomerOrder
...
def cart_items(request):
    ...
    user = request.user
    total = Order.objects.filter().aggregate(thedata=Sum('total_price'))
